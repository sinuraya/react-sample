...
class Nav extends Component {
	...
	render() {
		return (
			<ul className="nav">
				<li className={this.isPathActive('/itembank') || this.state.itemBankMenuOpen ? 'active' : null}>
					<a
						onClick={() =>
							this.setState({
								itemBankMenuOpen: !this.state.itemBankMenuOpen
							})}
					...
					<Collapse in={this.state.itemBankMenuOpen}>
						<div>
							<ul className="nav">
								<li className={this.isPathActive('/itembank') ? 'active' : null}>
									<Link to="/itembank">Item Bank List</Link>
								</li>
								<li className={this.isPathActive('/itembank/item') ? 'active' : null}>
									<Link to="/itembank/item">Items</Link>
								</li>
							</ul>
						</div>
					</Collapse>
				</li>
				<li className={this.isPathActive('/user') || this.state.userMenuOpen ? 'active' : null}>
					<a
						onClick={() =>
							this.setState({
					...
					<Collapse in={this.state.userMenuOpen}>
						<div>
							<ul className="nav">
								<li className={this.isPathActive('/user') ? 'active' : null}>
				...
				<li className={this.isPathActive('/forms') || this.state.formMenuOpen ? 'active' : null}>
					<a
						onClick={() =>
							this.setState({
								formMenuOpen: !this.state.formMenuOpen
							})}
						data-toggle="collapse"
					>
				...
				<li className={this.isPathActive('/maps') || this.state.mapMenuOpen ? 'active' : null}>
					<a
						onClick={() =>
							this.setState({
								mapMenuOpen: !this.state.mapMenuOpen
							})}
						data-toggle="collapse"
					>
